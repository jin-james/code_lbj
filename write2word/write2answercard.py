...
# 		is_fillin_breakpage = True
# 	else:
# 		ques_no, fill_no, page_num = fillin_in_choice_judgement(fillin_len, ques_no, page_num, document, is_fillin_breakpage = False)
# 		is_fillin_breakpage = True
...
# 		ques_no, fill_no, num, is_fillin_breakpage = choice60_(fillin_len, rest, ques_no, document, fill_no, is_fillin_breakpage)
# 		page_num += num
...
# 			ques_no, fill_no, num, is_fillin_breakpage = choice60_(fillin_len, else_choice, ques_no, document, fill_no, is_fillin_breakpage)
# 			page_num += num
# 			fillin_page = page_num
# 		else:
...
# 			ques_no, fill_no, num, is_fillin_breakpage = choice0_60(fillin_len, choice_len, ques_no, document, fill_no, is_fillin_breakpage)
# 			page_num += num
# 			fillin_page = page_num
...
# 		page_num += 1
# 		eassy_page = page_num
# 	div1, div2 = divmod(subjec_len, 2)
# 	sub_page_num = div1 + 1 if fillin_len else div1
...
# 	if choice_len:
# 		if fillin_len:
# 			sub_mark_num_vec.append(10)
# 			if fillin_page > choice_page:
# 				for n in range(1, fillin_page-1):
