...
def ichoice_sub_write(table, r, c, n, ques_no, isfillin=False):
    ...
    if isfillin:
        p.add_run().add_break()
        p.add_run(str(ques_no) + '题、______________________' + ' ')
    else:
        p.add_run().add_break()
...
if __name__ == '__main__':
    ...
    paper_num_count_flag = 0  # 页面是否有条形码显示页码
    ...
    p = document.add_paragraph()
    # p.add_run().add_picture(r'D:\校本资源相关\mark_pic\bmp小尺寸\prefix_2.png')
    ...
    document.save(r'C:\Users\j20687\Desktop\answersheet0509.docx')
